					...
					<div class="app-card-orders-table shadow-sm mb-5">
						<div class="app-card-body">
							<div id="myTable">
								...
								<c:forEach items="${weeklyList}" var="wbean">
									<div class="app-card mb-4 table-responsive">
										<!-- 		<div id="myTable"> -->
										...
										<span style="float: right" class="p-2 h4">Total :
											${wbean.amount}</span>
									</div>
								</c:forEach>
...
<c:if test="${display == 'period'}">
	<div class="row g-3 mb-4 align-items-center justify-content-between">
		...
		<div class="row">
			<div class="col-10"></div>
			<div class="col-2">
				<button type="button" class="btn" style="background-color: #51B37F;"
					id="downloadPdfBtn" onclick="GeneratePdf()">Download PDF</button>
			</div>
		</div>
		<!--//table-utilities-->
		<!--//row-->
				...
				<div class="app-card-orders-table shadow-sm mb-5">
					<div class="app-card-body">
						<div id="myTable">
							...
							<c:forEach items="${monthlyList}" var="mbean">
								<div class="app-card mb-4 table-responsive">
										...
										<table class="table app-table-hover mb-0 text-left">
											...
											<tbody>
												...
												<tr>
													...
													<td class="cell" rowspan="${mbean.nrow }">${mbean.days}</td>
													<c:forEach items="${transactionListByMonth}" var="rbean">
														<c:set var="tbean" value="${rbean.transactionBean}"></c:set>
														<c:if test="${ tbean.days eq mbean.days }">
				...
				<div class="app-card-orders-table shadow-sm mb-5">
					<div class="app-card-body">
						<div id="myTable">
							...
							<c:forEach items="${yearlyList}" var="mbean">
								<div class="app-card mb-4 table-responsive">
									<table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
										...
										<tbody>
											...
											<tr>
												<td class="cell" rowspan="${mbean.nrow }">${mbean.months}</td>
												<c:forEach items="${transactionListByYear}" var="rbean">
													<c:set var="tbean" value="${rbean.transactionBean}"></c:set>
													<c:if test="${rbean.month eq mbean.months}">
