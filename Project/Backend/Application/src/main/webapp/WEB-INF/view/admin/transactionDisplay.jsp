	...
	<div class="modal-dialog">
		<div class="modal-content p-4">
			...
			<f:form modelAttribute="tbean" action="updateTransaction"
				method="Post">
				<div class="row mb-3">
					<label for="trans_amount" class="col-sm-4 col-form-label">eId</label>
					<div class="col-sm-7">
				...
				<div class="row mb-3">
					<label for="trans_amount" class="col-sm-4 col-form-label">uId</label>
					<div class="col-sm-7">
						<f:input type="text" path="trans_user_id" class="form-control"
							id="trans_user_id1" />
					</div>
				</div>
				<div class="row mb-3">
